...
PanelWindow {
    ...
    property string wallpaperFolder: "file://" + Quickshell.env("HOME") + "/.config/supersection/wallpapers"

    Process {
        id: folderLoader
        // Call cat directly and pass the path as the second array item
        command: ["cat", Quickshell.env("HOME") + "/.config/supersection/settings/wallpaper-folder"]
        running: true
                ...
                SettingsWheel {
                    ...
                    Menu {
                        ...
                        SuperSectionMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/supersection/scripts/supersection-wallpaper --random"])
                            } 
                        }
                        ...
                        SuperSectionMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/supersection/scripts/supersection-wallpaper-effects"])
                            } 
                        }
                        ...
                        SuperSectionMenuItem { 
                            ...
                            onClicked: {
                                root.isOpen = false
                                Quickshell.execDetached(["bash", "-c", Quickshell.env("HOME") + "/.config/supersection/scripts/supersection-clear-wallpaper-cache"])
                            } 
                        }
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                let scriptPath = Quickshell.env("HOME") + "/.config/supersection/scripts/supersection-wallpaper";
