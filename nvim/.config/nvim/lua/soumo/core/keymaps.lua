...
keymap.set("n", "<leader>tt", "<cmd>tabnew | term<CR>", { desc = "Open terminal in new tab" }) -- open terminal in new tab
...
keymap.set("n", "<C-`>", "<cmd>split | term<CR>", { desc = "Open terminal in a horizontal split" }) -- open terminal horizontally
