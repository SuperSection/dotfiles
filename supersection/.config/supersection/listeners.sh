...
declare -A LISTENERS
LISTENERS["gtk-theme-switcher"]="$HOME/.config/supersection/listeners/gtk-theme-switcher.sh"
LISTENERS["low-bat-notification"]="$HOME/.config/supersection/listeners/low-bat-notification.sh"
# Example for another listener:
# LISTENERS["another-listener"]="$HOME/.config/supersection/listeners/another-listener.sh"
